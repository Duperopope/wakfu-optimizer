...
const DEFAULT_BONUSES: Bonus[] = [
  {
    id: 1, label: "Bonus de Guilde", shortLabel: "Guilde", icon: "tree", active: false,
  ...
  {
    id: 2, label: "Bonus de Havre-Monde", shortLabel: "Havre", icon: "gem", active: false,
    stats: { HP: 10, WISDOM: 10, PROSPECTION: 10 },
  },
  {
    id: 3, label: "Bonus de Monture", shortLabel: "Monture", icon: "mount", active: false,
